          ...
          <div className="lg:col-span-2">
            ...
            <Card className="overflow-hidden mb-6">
              <div className="aspect-video relative">
                <img
                  src={vehicle.image_url || "/images/fallback.png"}
                  onError={(e) => {
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {vehicle.mpg_city} MPG
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Highway</span>
                        <span className="font-medium">
                          {vehicle.mpg_highway} MPG
                        </span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {vehicle.cargo_volume} cu ft
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Towing Capacity</span>
                        <span className="font-medium">
                          {vehicle.towing_capacity > 0
                            ? `${vehicle.towing_capacity.toLocaleString()} lbs`
                            : "N/A"}
                        </span>
                      </div>
                    </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <a href="/compare">Compare Vehicles</a>
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full"
